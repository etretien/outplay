...
export const generateRestoreLetter = (link: string) => ({
  html: `
        <h1>Hello!</h1>
        <p>Please, copy and past the following code into outplay app in Forgot Password section to restore your password:</p>
        <p>${link}</p>
    `,
  text:
    'Hello! Please, copy and past the following code into outplay app in Forgot Password section to restore your password:\n' +
    link,
});
